    ...
    if (editorValue instanceof String) {
      ...
      if (!stringValue.isEmpty()) {
        ...
        if (stringValue.length() > DISPLAY_VALUE_MAX_LENGTH) {
          stringValue = stringValue.substring(0, DISPLAY_VALUE_MAX_LENGTH - 3) + org.polarsys.capella.common.ui.massactions.core.edit.control.many.Messages.ManyRefCellControl_0;
        }
