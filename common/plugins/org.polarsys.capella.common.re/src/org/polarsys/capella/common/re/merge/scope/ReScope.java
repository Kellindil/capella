...
public abstract class ReScope extends ReferenceModelScope implements INotifyListener {
  ...
  public boolean add(EObject source, EAttribute attribute, Object value) {
    System.out.println(NLS.bind(Messages.ReScope_3, new String[] { EObjectLabelProviderHelper.getText(source), attribute.getName(),
                                                                 EObjectLabelProviderHelper.getText(value) }));
  ...
  public void removeFromScope(EObject element) {
    System.out.println(NLS.bind(Messages.ReScope_5, new String[] { EObjectLabelProviderHelper.getText(element) }));
  ...
  public boolean remove(EObject source, EAttribute attribute, Object value) {
    System.out.println(NLS.bind(Messages.ReScope_6, new String[] { EObjectLabelProviderHelper.getText(source), attribute.getName(),
                                                                    EObjectLabelProviderHelper.getText(value) }));
  ...
  public boolean remove(EObject source, EReference reference, EObject value) {
    System.out.println(NLS.bind(Messages.ReScope_7, new String[] { EObjectLabelProviderHelper.getText(source), reference.getName(),
                                                                    EObjectLabelProviderHelper.getText(value) }));
