...
public class Messages extends NLS {
	...
	public static String ExtendedTopologicalSorter_0;
	public static String ExtendedTopologicalSorter_1;
	public static String SharedWorkflowActivityParameter_0;
	static {
