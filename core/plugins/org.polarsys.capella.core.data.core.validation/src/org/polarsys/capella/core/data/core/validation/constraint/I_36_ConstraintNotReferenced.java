...
public class I_36_ConstraintNotReferenced extends AbstractValidationRule {
    ...
    if (eObject instanceof Constraint) {
      ...
      if (EObjectExt.getReferencers(constraint, references).isEmpty()) {
        ...
        if (container instanceof StateTransition) {
          return failMessage(ctx, constraint, Messages.I_36_ConstraintNotReferenced_0, container);
          
        } else if (container instanceof StateEvent) {
          return failMessage(ctx, constraint, Messages.I_36_ConstraintNotReferenced_1, container);
          
        } else if (container instanceof SequenceMessage) {
          return failMessage(ctx, constraint, Messages.I_36_ConstraintNotReferenced_2, container);
          
        } else if (container instanceof Scenario) {
          return failMessage(ctx, constraint, Messages.I_36_ConstraintNotReferenced_3, container);
          
        } else if (container instanceof AbstractCapability) {
          return failMessage(ctx, constraint, Messages.I_36_ConstraintNotReferenced_4, container);
          
        } else if (container instanceof InteractionOperand) {
          return failMessage(ctx, constraint, Messages.I_36_ConstraintNotReferenced_5, container);
  ...
  protected IStatus failMessage(IValidationContext ctx, Constraint constraint, String feature, EObject container) {
    ...
    String result = NLS.bind(Messages.I_36_ConstraintNotReferenced_6, new String[] {feature, b, c});
